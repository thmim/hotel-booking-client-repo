                ...
                >
                    {hotels.map((room) => (
                        <motion.div
                            ...
                            className="bg-white rounded-xl shadow-lg transform hover:scale-105 transition-all duration-300 overflow-hidden flex flex-col cursor-pointer"
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                ...
                                <div className="mt-auto pt-4 border-t border-gray-100">
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.95 }}
                                        className="w-full bg-indigo-600 text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300 focus:outline-none hover:bg-indigo-700"
                                    >
                                        Book Now
                                    </motion.button>
                                </div>
