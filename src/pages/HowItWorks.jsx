...
const HowItWorks = () => {
    const steps = [
        {
            icon: <FaSearch />, // React Icon component
        ...
        {
            icon: <FaHotel />, // React Icon component
        ...
        {
            icon: <FaSuitcaseRolling />, // React Icon component
    ...
    return (
        <section className="relative w-full overflow-hidden py-16 md:py-24 bg-base-100">
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center mb-12">
                    <h2 className="text-4xl lg:text-5xl font-extrabold text-primary-focus mb-4 relative inline-block">
                        ...
                        <span className="block w-28 h-1 bg-secondary mx-auto mt-4 rounded-full"></span>
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
                    {steps.map((step, index) => (
                        <div
                            key={index}
                            className="bg-base-300 bg-opacity-80 backdrop-blur-sm p-8 md:p-10 rounded-xl shadow-lg
                        ...
                        >
                            ...
                            <h3 className="text-3xl font-bold text-neutral mb-2 relative pb-2">
                                {step.title}
                                <span className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-12 h-1 bg-secondary rounded-full"></span>
                            </h3>
